...
@section('content')
    <div class="container">
        <p class="text-center text-white bg-dark form-control">Solicitud de alta de materia</p>
        <div class="row">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col">
                            ...
                            <input name="semester" disabled type="text" class="form-control" id="semester" value="8 Semestre">
                        </div>
                        <div class="col">
